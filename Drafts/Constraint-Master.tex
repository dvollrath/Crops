...
\vspace{.05in} \noindent We show that the effect of population and productivity shocks on living standards in depends on the elasticity of agricultural output with respect to land. We then estimate this elasticity using rural density and agricultural productivity data from 35,451 districts around the world. The estimated elasticity in temperate districts is twice that in tropical districts, and the difference is robust across specifications. The elasticities imply living standards are more sensitive to shocks in temperate areas, which we confirm using evidence from the post-war mortality transition. Our results suggest why temperate areas had an advantage in developing over the long run. 
