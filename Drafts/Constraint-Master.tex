...
Add $g$ subscript for geographic region, and $\beta_g$. Make more clear that we run this for specific $g$. Change to "temperate" versus "tropical" agriculture, rather than "Wheat/Rice"? Use residual plot to show difference? 
