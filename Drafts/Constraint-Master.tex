...
The estimated size of the elasticities, and their patterns across agriculture type, climate zone, and region are not driven by different levels of development or supplies of capital and other inputs. The differences we estimate hold even if we exclude developed countries from our analysis. We also find the same heterogeneity in elasticities by agricultural type if we look within geographically heterogenous countries (e.g. China). Further, given that we use only within-province variation in density and productivity to make our estimates, any variation in capital or the level of productivity across \textit{provinces} is ignored. 
